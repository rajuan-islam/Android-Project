...
public class LegendActivity extends Activity implements ListFragment.ListFragmentInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * */
        ...
        // setting up tab 1
        TabHost.TabSpec spec = tabHost.newTabSpec("Tag 1");
        spec.setContent(R.id.tab1);
        spec.setIndicator("Legends");
        tabHost.addTab(spec);

        // setting up tab 2
        spec = tabHost.newTabSpec("Tag 2");
        spec.setContent(R.id.tab2);
        spec.setIndicator("Biography");
        tabHost.addTab(spec);
